...
Q.TagDataRetriever.prototype.__pollLocation = function(o) {
	...
	jQuery.ajax({
        url : "http://localhost:8001/frontend/getTagPosition",
		//url : "../qpe/getTagPosition?" + q + maxAge + radiusThreshold,
...
Q.TagDataRetriever.prototype.__pollTagInfo = function(o) {
	...
	jQuery.ajax({
        url : "http://localhost:8001/frontend/getTagInfo",
		//url : "../qpe/getTagInfo?" + q,
		dataType : 'json',
		async : true,
		success : function(data, textStatus, jqXHR) {
			//console.log(data);
